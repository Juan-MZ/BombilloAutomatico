...
void USART_Init(long baud_rate)
{
    ...
    temp=Baud_value;     
    SPBRG = (((float)(F_CPU)/(float)baud_rate)-1);             /*baud rate=9600, SPBRG = (F_CPU /(64*9600))-1*/
...
{        
        ...
        TXREG=out;                 /*wait for transmit interrupt flag to set which indicates TXREG is ready                                   for another transmission*/    
}
/*******************RECEIVE FUNCTION*****************************************/
char USART_RxChar()
{ 
